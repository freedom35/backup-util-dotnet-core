# Backup Utility (.NET 10.0)

Backup Utility is a console app that copies files from multiple source directories to a common target directory.  

The app is written as a **.NET 10.0** console app rather than a service in order to remain portable between Windows, macOS, and Linux.  
...
## Requirements
Executing the app requires [.NET 10.0 Runtime](https://dotnet.microsoft.com/download/dotnet/10.0/runtime) to be installed.  
